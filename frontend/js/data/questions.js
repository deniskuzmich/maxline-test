export const questionsData = [
    {
        id: 1,
        question: "Для активации приветственного бонуса '1000FS' нужно:",
        options: [
            "Верификация, авторизация в приложении, пополнение от 30р",
            "Верификация, пополнение от 20р",
    ...
    {
        id: 2,
        question: "Для активации приветственного бонуса '150BYN' нужно:",
        options: [
            "Верификация, авторизация в приложении, пополнение от 30р",
    ...
    {
        id: 5,
        question: "С какими коэффициентами можно использовать фрибет для ставок на спорт?",
    ...
    },
    {
        ...
        options: ["1.5 - 3", "от 1.2", "до 5", "до 3"],
        correct: 3
    },
    {
        id: 14,
    ...
    },
    {
        ...
        options: [
            "Верификация, пополнение от 30р, нажать кнопку 'Принять участие'",
    ...
    {
        id: 16,
        question: "К какому результату приведет невыполнение условий по VIP CASHBACK для участника со статусом 'Bronze Pro'?",
        options: [
            "Участник сохранит статус Bronze Pro, но не получит кэшбэк за прошедший месяц",
            ...
            "Статус будет понижен до уровня Bronze Elite, так как при понижении внутри категории Bronze всегда выбирается крайний верхний статус следующей ступени."
        ],
        correct: 2
    },
    {
        ...
        options: ["5% и 20%", "10% и 30%", "4% и 100%", "5% и 50%"],
        correct: 0
    },
    {
        id: 18,
        ...
        options: [
            "Silver и Gold производится раз в три месяца",
            "Platinum производится раз в месяц",
            "Gold и Platinum раз в три месяца",
            "Правильных вариантов нет"
        ],
        correct: 3
    },
    ...
    },
    {
        ...
        options: [
            "Авторизация через приложение, депозит от 20 BYN.",
    ...
    {
        id: 26,
        question: "Если игрок активировал бонус 22% для КАЗИНО и совершил вывод средств, через какое время ему станет доступно повторное использование этого бонуса?",
        options: [
            "Через 24 часа.",
            "Через 48 часов.",
            "Через 5 дней.",
    ...
    },
    {
        ...
        options: [
            "Необходимо нажать 'участвовать' пополнить счет на 20 BYN до совершения прогноза.",
    ...
    {
        id: 32,
        question: "Если игрок активировал бонус 22% для СПОРТА и совершил вывод средств, через какое время ему станет доступно повторное использование этого бонуса?",
        options: [
            "Через 24 часа.",
            "Через 48 часов.",
            "Через 5 дней.",
